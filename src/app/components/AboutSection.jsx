...
const TAB_DATA = [
  ...
  },
  {
    ...
    content: (
      <ul className="list-disc pl-2">
        <li>Indian Institute of Information Technology, Una</li>
  ...
  },
  {
    ...
    content: (
      <ul className="list-disc pl-2">
        <li>Full Stack Developer intern at PNAPAAO</li>
        <li>Data Science Intern at IISC Bangalore</li>
        <li>Frontend Intern at NullClass</li>
      </ul>
    ),
  },
];
