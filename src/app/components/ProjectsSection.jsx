...
const projectsData = [
  {
    ...
    description: "A weather forecasting website that uses API and location access from the user and tells the weather of any location using the inputted city name or pincode and also tells the forecast for the next 6 days.",
